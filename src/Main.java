...
public class Main
{
    ...
    public static void main(String[] args) {
        ...
        album1.addSongtoAlbum("LastRide", 4.0);
        album1.addSongtoAlbum("So High", 5.3);

        Album album2 = new Album("Arjit's Song", "Arjit Singh");
        album2.addSongtoAlbum("Kesariya", 5);
        album2.addSongtoAlbum("Jenna Jeena", 3);
        album2.addSongtoAlbum("Geruva", 7);

        albums.add(album1);
        albums.add(album2);

        System.out.println(album1.findSong("Geruva"));
